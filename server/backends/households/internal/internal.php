    ...
    namespace backends\households {
        ...
        class internal extends households {
            ...
            public function getDomophones($by = "all", $query = -1, $withStatus = false) {
                $previewCamSql = "(select e.camera_id from houses_entrances e where e.house_domophone_id = houses_domophones.house_domophone_id and coalesce(e.camera_id,0) > 0 order by e.house_entrance_id asc limit 1) as preview_camera_id";

                $q = "select houses_domophones.*, $previewCamSql from houses_domophones order by house_domophone_id";
                ...
                $r = [
                    ...
                    "sos" => "sos",
                    "tree" => "tree",
                    "preview_camera_id" => "previewCameraId",
                ];
                ...
                switch ($by) {
                    case "house":
                        ...
                        $q = "
                            select houses_domophones.*, $previewCamSql from houses_domophones where house_domophone_id in (
                    ...
                    case "ip":
                        ...
                        $q = "select houses_domophones.*, $previewCamSql from houses_domophones where ip = '$query'";
                        break;

                    case "subId":
                        $q = "select houses_domophones.*, $previewCamSql from houses_domophones where sub_id = '$query'";
                        break;
                    ...
                    case "tree":
                        ...
                        $q = "select houses_domophones.*, $previewCamSql from houses_domophones where tree like concat(:tree::character varying, '%') order by house_domophone_id";
                        $p = [
                            "tree" => $query,
                        ];
                        break;
