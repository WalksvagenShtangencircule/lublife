            ...
            public static function POST($params) {
                ...
                array_unshift($messages, [
                    ...
                    "content" => "Ты встроенный аналитический помощник **этого конкретного сервера SmartAccess**. " .
                        ...
                        "ВСЕГДА копируй значение поля дословно как href Markdown-ссылки, НЕ придумывай и НЕ изменяй ID. " .
                        "Формат: [подпись](значение_поля_url). Если поля _url нет — не выводи ссылку вообще. " .
