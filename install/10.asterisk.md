...
## Виртуальная QR-панель и DTMF из приложения

Отдельный чеклист (конфиг `vdom_dtmf`, AMI `[rbtdom]`, слушатель PHP, systemd, логи): **[16.vdom_qr_dtmf.md](16.vdom_qr_dtmf.md)**.
