...
Для виртуальных панелей с открытием по DTMF: заполните `vdom_dtmf` в server `config.json` (см. `config.sample.json5`) и настройте AMI + systemd по [§6 в 10.asterisk.md](10.asterisk.md).
