...
Для виртуальных панелей с открытием по DTMF: заполните `vdom_dtmf` в server `config.json` (см. `config.sample.json5`), затем [чеклист 16.vdom_dtmf_checklist.md](16.vdom_dtmf_checklist.md) и [§6 в 10.asterisk.md](10.asterisk.md).
