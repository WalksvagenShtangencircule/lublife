    ...
    init: function () {
        ...
        if (AVAIL("tt", "tt", "GET")) {
            if (parseInt(myself.uid) == 0) {
                leftSide("fas fa-fw fa-clipboard-list", i18n("tt.menuSidebar"), "?#tt.settings", "tt");
                this.menuItem = false;
            } else {
                this.menuItem = leftSide("fas fa-fw fa-clipboard-list", i18n("tt.menuSidebar"), "?#tt", "tt");

                if (AVAIL("tt", "customFilter")) {
                    leftSide("fas fa-fw fa-filter", i18n("tt.customFilterSidebar"), `?#tt&filter=empty&customFilter=yes`, "tt");
                }
